...
| **FEAT-04** | **Video Studio & Timeline Pro (con Herramienta Looper en Inspector & Multi-Clip)** | FastAPI / FFmpeg / Moviepy | [Ficha Técnica](file:///e:/autoprod/docs/features/video_looper/ficha_tecnica.md) \| [Idea & Escalabilidad](file:///e:/autoprod/docs/features/video_looper/idea.md) |
...
| **FEAT-08** | **Image Studio (Estudio de Imágenes)** | DALL-E 3 / OpenAI Vision | [Ficha Técnica](file:///e:/autoprod/docs/features/image_generator/ficha_tecnica.md) \| [Idea & Escalabilidad](file:///e:/autoprod/docs/features/image_generator/idea.md) |
